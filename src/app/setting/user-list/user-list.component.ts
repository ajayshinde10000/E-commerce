...
export class UserListComponent implements OnInit {
  ...
  updateUser(){
    ...
    this.userService.updateUserInfo(obj,this.userId).subscribe((data)=>{
      console.log(data);
      this.loadUsers();
  ...
  updateRole(){
    this.userService.updateUserRole(this.userId, this.role.toLowerCase()).subscribe((data)=>{
      console.log(data);
  ...
  sortByName(val:any){
    ...
    this.userService.sortWithLimit(val,this.limit,this.page).subscribe((data:any)=>{
      this.userArr = data.results;
      if(val=='name'){
        this.userArr.sort();
        console.log("Data From Sorting",this.userArr);
  ...
  pageChange(ind:any){
    this.page = ind;
    this.userService.getUsersByPageAndLimit(this.limit,this.page).subscribe((data:any)=>{
      this.userArr = data.results;
    })
  }
